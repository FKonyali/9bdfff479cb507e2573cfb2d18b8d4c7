        ...
        <div class="payment__left payment__col">
                ...
                <div class="payment__c-front front">
                    <svg version="1.1" id="cardfront" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 750 471" style="enable-background:new 0 0 750 471;" xml:space="preserve">
                        <g id="Front">
                            ...
                            <text transform="matrix(1 0 0 1 60.106 295.0121)" id="svgnumber" class="st2 st3 st4">{{getForm.card_number ? getForm.card_number : '0123 4567 8910 1112'}}</text>
                            <text transform="matrix(1 0 0 1 54.1064 428.1723)" id="svgname" class="st2 st5 st6">{{getForm.card_name ? getForm.card_name : 'AD SOYAD'}}</text>
                            <text transform="matrix(1 0 0 1 54.1074 389.8793)" class="st7 st5 st8">cardholder name</text>
                            <text transform="matrix(1 0 0 1 479.7754 388.8793)" class="st7 st5 st8">expiration</text>
                            <text transform="matrix(1 0 0 1 65.1054 241.5)" class="st7 st5 st8">card number</text>
                            <g>
                                <text transform="matrix(1 0 0 1 574.4219 433.8095)" id="svgexpire" class="st2 st5 st9">{{getForm.card_date_month ? getForm.card_date_month : '01'}}/{{getForm.card_date_year ? getForm.card_date_year : '2021'}}</text>
                ...
                <div class="payment__c-back back">
                    <svg version="1.1" id="cardback" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 750 471" style="enable-background:new 0 0 750 471;" xml:space="preserve">
                        ...
                        C707.1,246.4,704.4,249.1,701.1,249.1z"></path>
                            ...
                            <text transform="matrix(1 0 0 1 621.999 227.2734)" id="svgsecurity" class="st6 st7">{{getForm.card_cvv ? getForm.card_cvv : '985'}}</text>
                            <g class="st8">
            ...
            <div class="payment__c-info">
                ...
                <div class="payment__ci-item">
                    ...
                    <input type="text" class="payment__c-input" placeholder="Kartın Üzerindeki İsimi Giriniz" v-model="getForm.card_name" maxlength="20">
                </div>
                <div class="payment__ci-item">
                    <label class="payment__c-label">
                        Kartın Numarası
                    </label>
                    <input type="text" class="payment__c-input" placeholder="Kartın Numarasını Giriniz" v-model="getForm.card_number" maxlength="16">
                </div>
                <div class="payment__ci-group">
                    <div class="payment__ci-gleft">
                        ...
                        <div class="payment__ci-flex">
                            <select name="mount" id="month" v-model="getForm.card_date_month">
                                <option value="" disabled>Ay</option>
                                <option :value="counter" v-for="(counter, index) in 12" :key="index">{{counter}}</option>
                            </select>
                            <select name="year" id="year" v-model="getForm.card_date_year">
                    ...
                    <div class="payment__ci-gright">
                        ...
                        <input type="text" name="cvv" id="cvv" class="payment__c-input" placeholder="CVV Giriniz" v-model="getForm.card_cvv" @focus="flip = true" @blur="flip = false" maxlength="4">
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="payment__result">
                    <div class="payment__r-list">
                        ...
                        <div class="payment__r-item">
                            ...
                            <div class="payment__r-right">
                                {{getForm.hotel.percent}}
                            </div>
                        </div>
                        <div class="payment__r-item">
                            <div class="payment__r-left">
                                Konaklama <span>(5 Gün)</span>
                            </div>
                            <div class="payment__r-right">
                                5.635 TL
                            </div>
